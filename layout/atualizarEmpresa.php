...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <!-- Coluna para a foto -->
            <div class="col-md-4">
                <img src="<?php echo $util->montarCaminhoLogotipo(null, $empresa->getIdEmpresa()) ?>"
                    alt="<?php echo $empresa->getNomeEmpresa() ?>" class="img-fluid">
            </div>
            <!-- Coluna para o formulário -->
            <div class="col-md-8">
                <form action="../src/actions/processarAtualizacaoEmpresa.php" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nome" id="nome"
                            value="<?php echo $empresa->getNomeEmpresa() ?>">
                    </div>
                    <div class="mb-3">
                        <label for="matricula" class="form-label">Status do cadastro:</label>
                        <!-- <input type="text" class="form-control" name="status" id="status" value="<?php echo $empresa->getStatusEmpresa() ?>"> -->
                        <label>
                            <input type="radio" class="form-contro" name="status" id="status" value="1" <?php if ($empresa->getStatusEmpresa() == 1)
                                echo "checked" ?>>Ativo
                            </label>
                            <label>
                                <input type="radio" class="form-contro" name="status" id="status" value="0" <?php if ($empresa->getStatusEmpresa() == 0)
